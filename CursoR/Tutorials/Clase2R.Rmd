...
Existe un repositorio oficial llamado [CRAN]([https://cran.r-project.org/)](https://cran.r-project.org/)) de donde se pueden descargar versiones estables de los paquetes.Además existen otros repositorios no oficiales como [Github]([https://github.com)](https://github.com)) en donde los desarrolladores tienen sus versiones de prueba, pero con mayores características, dado que son versiones nuevas de los paquetes que aún no salen a producción.
